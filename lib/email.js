    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Selamat Datang Di Rest-APIs LORENZO</h3>
            <p>
...
Jika Kamu Memiliki Masalah, Silahkan Hubungin Saya Via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6285894094841">WhatsApp</a></span></span>
            <span style="display: block;"><br>By,<br>LORENZO</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"LORENZO" <contact@lorenzo.my.id>',
        to: email,
        subject: 'Verify Email - Api LORENZO',
        html: inboxGmail,
      };
